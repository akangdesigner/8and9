...
| `m8` | Lewis(男性,平頭、短袖有領襯衫+皮帶長褲)| 教官——2026-09-11,kc 說跟 m2 那群撞臉要專屬;衣服顏色靠 `tools/paint_uv_regions.py` 程式填色的 UV 貼圖(`char-jiaoguan-body-uv.png`),不是材質分件,見「單一 mesh 但沒有獨立上衣」 | `base-human-m8-` |
| `m9` | Adam(男性,灰色連帽運動套裝,有獨立 Beard mesh)| 阿伯(廟口顧廟)——2026-09-16,免費庫沒有老人男性,拿 Adam 弄老:身高 .9、頭髮+鬍子染灰白;分件乾淨 `Ch08_Body/Hoodie/Pants/Sneakers/Hair/Beard/Eyelashes` | `base-human-m9-` |
