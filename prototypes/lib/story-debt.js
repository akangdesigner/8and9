...
(function (root) {
  ...
  const NODES = [
       ...
       (game.html debtDragHome)。哪些選項出現看你找過誰(item.when);三個都沒問到就只剩「⋯⋯」那條。 ── */
    {
      ...
      /* 家裡是一張照片,寫不了推人/掃桌子那種畫面(kc:「我的場景做不了這麼複雜」)——
         暴力全放在聲音跟他講的話裡。 */
      beats: [
        { who:'pc',        text:'下午四點。鐵門被拍得砰砰響,一下比一下急。' },
        { who:'collector', text:'「開門。我知道你在。」' },
        { who:'pc',        text:'你把門打開一條縫。' },
      ...
      menu: [
           ...
           鋪陳 逼你三選一」)——game.html debtResolve('none') 直接 triggerGameOver('debt')。 */
        {
          ...
          beats: [
            { who:'pc',        text:'你講不出話。' },
            { who:'collector', text:'「沒有人替你出面?」' },
            { who:'collector', text:'「好。」' }
          ]
        }
      ]
    },
  ...
  const GAME_OVER = '他們把你拖到樓梯間。你不記得挨了幾拳，只記得最後是趴在地上聽他們的腳步聲上樓。回到家的時候鐵門開著，能搬的都搬走了，連你的床、連牌位。媽沒有回來，爸不知道去了哪裡。那天晚上你坐在空掉的客廳，發現這個城市沒有一個地方是留給你的。';
